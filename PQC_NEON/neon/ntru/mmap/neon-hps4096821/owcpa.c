...
static poly *f_kp, *g_kp, *invf_mod3_kp, *gf_kp, *invgf_kp, *tmp1_kp, *tmp2_kp, *invh_kp, *h_kp;
...
static poly *c_dec, *f_dec, *finv3_dec, *cf_dec, *mf_dec, *m_dec, *invh_dec, *r_dec, *b_dec;
